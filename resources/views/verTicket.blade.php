		   ...
		   <div style="text-transform: uppercase;" class="panel-heading text-center">
			...
			<div class="container-fluid">
				...
				<div class="col-md-3 form-inline">
	    			...
	    			{!! Form::select('guardian',\App\User::lists("nombre","id"), $ticket->guardian_id, ['id'=> 'estado','class' => 'form-control chosen', 'onChange' => "cambiarGuardian($ticket->id , this.value)"]) !!}
				</div>
				@endif
				@endif
		...
		{!! Form::open(['method' => 'POST', 'url' => 'ajax/addComentarioTicket', 'class' => 'form-horizontal', 'id' => 'form-comentario', "files" => "true"]) !!}
			...
			<div id="input-avanced" style="display:none">
				...
				<div class="form-group @if($errors->first('emails[]')) has-error @endif">
				    ...
				    <div class="col-sm-8">
				    	{!! Form::select('emails[]',App\User::lists("nombre","id"),[$ticket->user_id,$ticket->guardian_id], ['id' => 'emails[]', 'class' => 'form-control chosen', 'required' => 'required', 'multiple']) !!}
